...
export default class Blog extends Component{
  ...
  constructor(props){
    ...
    this._componentLayoutJSX = <div>{this.blogContent.map((article, index) => <Preview key={index} id={article.id} topic={article.topic} firstPara={article.content[0].paragraph} />)}</ div>;
